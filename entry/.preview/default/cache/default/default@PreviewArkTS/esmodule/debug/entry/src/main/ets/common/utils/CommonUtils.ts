...
export class CommonUtils {
    ...
    private loginCheckArkTS(account: string, password: string): Resource | string {
        let check: string = '';
        if (account === '') {
            return { "id": 16777354, "type": 10003, params: [], "bundleName": "com.huawei.logindemo", "moduleName": "entry" };
        }
        else if (password === '') {
            return { "id": 16777355, "type": 10003, params: [], "bundleName": "com.huawei.logindemo", "moduleName": "entry" };
        }
